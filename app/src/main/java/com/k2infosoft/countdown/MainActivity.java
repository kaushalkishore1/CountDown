package com.k2infosoft.countdown;
...
public class MainActivity extends AppCompatActivity {
    ...
    private TextView tvEvent, btn_reg;
        ...
        runnable = new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    Date futureDate = dateFormat.parse("2017-1-1");
                    ...
                    if (!currentDate.after(futureDate)) {
                        ...
                        tvEvent.setText("Wishing You Very Very Happy New Year 2017!");
                        textViewGone();
                    }
                } catch (Exception e) {
                    e.printStackTrace();
